...
interface PersonWithParentsProps {
  personId: UniqueId
...
export class PersonWithParents extends ValueObject<PersonWithParentsProps> {
  static create(props: PersonWithParentsProps) {
    const personWithParentsProps: PersonWithParentsProps = {
      ...props,
    }
