...
import { TestImagesManipulatorProvider } from '@test/providers/TestImagesLocalManipulator.provider'
...
let ImagesManipulatorProvider: TestImagesManipulatorProvider
...
describe('Create Project', () => {
  beforeEach(() => {
    ...
    ImagesManipulatorProvider = new TestImagesManipulatorProvider()

    sut = new CreateProjectService(
      usersRepository,
      projectsRepository,
      ImagesManipulatorProvider,
    )
  })
